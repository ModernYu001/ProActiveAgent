...
选材优先级(素材足够时按此排序, 高优先的多写):
1. AI 工具实操玩法/工作流(Claude/Codex/Gemini 等) → 写成可收藏的步骤干货体
2. 免费额度/羊毛/限时优惠 → 讲清楚"怎么薅、值多少、截止时间"(以素材为准)
3. 带真实数字的成功案例(收入/用户数/涨星) → 突出数字和可借鉴的一个关键动作
4. 重大发布/融资等新闻 → 才用观点评论体
